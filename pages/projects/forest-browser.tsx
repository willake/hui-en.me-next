...
const ForestBrowser: NextPage = () => {
  let data: ProjectArticle = {
    ...
    keywords:
      'Forest, Forest Browser, Game, Gamification, Game Programmer, Willake, Lin Hui En, Game Development, Game Portfolio, Portfolio',
    size: '3',
    language: 'Javascript',
  ...
  return (
    <>
      ...
      <Content>
        ...
        <Paragraph>
          Forest Browser Extension is a mini gamification tool on Google Chrome
          and Firefox. It is like the Forest app, which is the main product of
          Seekrtech, but a feature-limited version. In this extension, users can
          set up a timer that blocks all websites except those in the allowed
          list. It was my first project at SeekrTech. I refactored the whole
          codebase and developed new features that connected with the server API
          of Forest. The experience was valuable, since I collaborated with a
          professional back-end engineer and gained a great deal of networking
          and database design knowledge.
        </Paragraph>
        <ImageBlock
      ...
      <Link
        title="Firefox"
        href="https://addons.mozilla.org/en-US/firefox/addon/forest-stay-focused-be-present/"
      >
        Firefox Addon
      </Link>
      <Link
        title="Chrome"
        href="https://chrome.google.com/webstore/detail/forest-stay-focused-be-pr/kjacjjdnoddnpbbcjilcajfhhbdhkpgk?hl=en"
      >
        Chrome Extension
      </Link>
    </>
