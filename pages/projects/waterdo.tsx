...
const WaterDo: NextPage = () => {
  let data: ProjectArticle = {
    ...
    keywords:
      'to-do list, WaterDo, Game, Gamification, Game Programmer, Willake, Lin Hui En, Game Development, Game Portfolio, Portfolio',
    size: 'over 10',
    language: 'Unity C#',
  ...
  return (
    <>
      ...
      <Content>
        ...
        <Paragraph>
          WaterDo is a to-do list app with a gamification feature that makes
          daily tasks interesting. In this app, users schedule their personal
          tasks as bubbles, popping them when they complete tasks. By popping
          bubbles, they gain energy for exploring stories in WaterDo. I served
          as a Unity programmer in this project, implementing main game features
          and working with a cross-functional team with professional people.
        </Paragraph>
        <VideoBlock
          title="WaterDo"
      ...
      <Link title="Official Website" href="https://waterdo.seekrtech.com/en/">
        Official Website
      </Link>
      <Link
        title="App Store"
        href="https://apps.apple.com/us/app/waterdo-to-do-list-notes/id1388228852"
      >
        App Store
      </Link>
      <Link
        title="Google Play Store"
        href="https://play.google.com/store/apps/details?id=com.seekrtech.waterapp"
      >
        Google Play Store
      </Link>
    </>
