...
const Meta: React.FC<MetaProps> = ({ title, keywords, description }) => {
  return (
    <Head>
      ...
      <meta name="twitter:creator" content="@WillakeLin" />
      <meta name="twitter:image" content="https://hui-en.me/images/cover.jpg" />
...
Meta.defaultProps = {
  ...
  keywords:
    'Game, Game Programeer, Game Developer, Hui En Lin, Hui-En, Willake, Programmer, Game Development',
};
